...
import { 
    Search, Building, User, LogOut, Menu, X, 
    ShieldCheck, ChevronDown, CheckCircle, PhoneCall, Lock
} from 'lucide-react';
...
const navItems = [
    {
        name: 'ค้นหาบุคลากร',
        href: '/phonebook/auth/personal',
        icon: User,
    },
    {
        name: 'ค้นหาสำนักงาน',
        href: '/phonebook/auth/department',
        icon: Building,
    },
        {
        name: 'เปลี่ยนรหัสผ่าน',
        href: '/phonebook/auth/changePassword',
        icon: Lock,
    },
];
...
const Sidebar = ({ isSidebarOpen, toggleSidebar, onLinkClick }) => {
    ...
    return (
        ...
        <Link href="/phonebook/auth/personal" className="flex items-center">
...
// ------------------------------------------------------------------
const Header = ({ toggleSidebar, isSidebarOpen, fullname }) => { 
    const [isMenuOpen, setIsMenuOpen] = useState(false);

    return (
        <header className="sticky top-0 flex-shrink-0 h-16 bg-white shadow-md border-b fixed">
            <div className="sticky top-0 max-w-full mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
