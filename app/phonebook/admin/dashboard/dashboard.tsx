...
<div className="mb-6 grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <Link href="/phonebook/admin/dashboard/requests">
        <div className="bg-orange-50 border border-orange-100 p-4 rounded-2xl flex items-center justify-between hover:bg-orange-100 transition-all cursor-pointer group">
            <div className="flex items-center gap-4">
                <div className="p-3 bg-orange-500 rounded-xl text-white shadow-lg shadow-orange-200">
                    <UserPlus size={24} />
                </div>
                <div>
                    <h3 className="font-bold text-orange-900">คำขอลงทะเบียนใหม่</h3>
                    <p className="text-sm text-orange-700">มี 3 รายการที่รอการตรวจสอบจากคุณ</p>
                </div>
            </div>
    ...
    {/* คุณสามารถเพิ่มปุ่มลัดอื่นๆ ตรงนี้ได้ */}
</div>
