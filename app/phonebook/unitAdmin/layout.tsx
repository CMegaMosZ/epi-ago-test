...
import { 
    Search, Building, Building2, User, LogOut, Menu, X, Lock,
    ShieldCheck, ChevronDown, CheckCircle, UserPen, History, PhoneCall
} from 'lucide-react';
...
const navItems = [
    {
        name: 'แก้ไขข้อมูลสำนักงาน',
        href: '/phonebook/unitAdmin/officeInfo',
        icon: Building,
    },
    {
        name: 'แก้ไขข้อมูลบุคลากร',
        href: '/phonebook/unitAdmin/userInfo',
        icon: UserPen ,
    },
    {
        name: 'เปลี่ยนรหัสผ่าน',
        href: '/phonebook/unitAdmin/changePassword',
        icon: Lock,
    },
];
...
const Sidebar = ({ isSidebarOpen, toggleSidebar, onLinkClick }) => {
    ...
    return (
        ...
        <Link href="/phonebook/unitAdmin/officeInfo" className="flex items-center">
...
const Header = ({ toggleSidebar, isSidebarOpen, fullname }) => { // ✅ รับ isSidebarOpen มาเพื่อปรับไอคอน
    ...
    return (
        <header className="flex-shrink-0 h-16 bg-white shadow-md border-b sticky top-0 z-index-150">
